...
void	map_draw_background(t_identifier *id, t_map *map, t_tile *tile)
{
	...
	tile->background.img_ptr = mlx_xpm_file_to_image(id->mlx, "./assets_xpm/test.xpm", &tile->tile_width, &tile->tile_height);
...
void	map_draw_wall_and_background(t_identifier *id, t_map *map, t_tile *tile)
{
	...
	path = "../assets_xpm/test.xpm";
	tile->background.img_ptr = mlx_xpm_file_to_image(id->mlx, path, &tile->tile_width, &tile->tile_height);
